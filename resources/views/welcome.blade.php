...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        @include('partials.head', ['title' => __('MyTasks')])
    </head>
    <body class="min-h-screen bg-[#262626] text-zinc-100 antialiased">
        ...
        <header class="fixed inset-x-0 top-0 z-50 h-[120px] border-b border-zinc-700 bg-[#262626]">
            <div class="mx-auto flex h-full max-w-6xl items-center justify-between px-5 sm:px-8">
                <a href="{{ url('/') }}" class="flex items-center gap-3 underline-offset-4 hover:underline">
                    ...
                    <span class="text-base font-semibold tracking-wide text-zinc-100">MyTasks</span>
                </a>
        ...
        <main class="mx-auto max-w-6xl px-5 sm:px-8">
            ...
            <section class="flex flex-col items-center py-20 text-center sm:py-28">
                <h1 class="text-5xl font-bold tracking-tight text-zinc-50 sm:text-6xl md:text-7xl">MyTasks</h1>
                <p class="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
                    A productivity-focused task manager with GTD workflows, time blocking, and analytics — built to keep you organized and motivated.
                </p>
            ...
            {{-- Features grid: 3 rows x 3 columns --}}
            <section class="py-12">
                ...
                <div class="grid gap-4 sm:grid-cols-3">
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        ...
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Full CRUD with statuses, priorities, due dates, and recurring daily tasks.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Workspaces</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Organize tasks into named workspaces by project or domain.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Inbox</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">GTD quick capture — collect ideas now, process them into tasks later.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Someday / Maybe</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Park non-actionable tasks and activate them when ready.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Time Blocks</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Schedule blocks of time on specific dates, optionally linked to a task.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Due Tasks</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Dedicated view for overdue and upcoming tasks that need attention.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Analytics</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Completion ratios and tasks completed per day over the last 14 days.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Mood Logging</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Log energy levels tied to tasks, with mood distribution charts.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Weekly Reviews</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">End-of-week summaries with completion rates and freeform notes.</p>
                    </div>
                </div>
            </section>
        ...
        <footer class="mt-12 border-t border-zinc-700">
            <div class="mx-auto flex max-w-6xl flex-col items-center gap-6 px-5 py-10 sm:flex-row sm:justify-between sm:px-8">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm font-medium text-zinc-400">MyTasks</span>
                </div>
